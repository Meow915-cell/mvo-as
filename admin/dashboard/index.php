      ...
      <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4">
        <div class="card">
          <section class="flex justify-between items-center">
            ...
            <div class="flex items-center justify-center size-12 rounded-full bg-orange-100 text-orange-500">
        ...
        <div class="card">
          <section class="flex justify-between items-center">
            ...
            <div class="flex items-center justify-center size-12 rounded-full bg-green-100 text-green-500">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="card">
          <section class="flex justify-between items-center">
            <div>
              ...
              <p class="text-2xl font-bold"><?php echo $total_services; ?></p>
            </div>
            <div class="flex items-center justify-center size-12 rounded-full bg-blue-100 text-blue-500">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="card">
          <section class="flex justify-between items-center">
            <div>
              <p class="mb-2 text-sm font-medium text-gray-600">Total Veterinarians</p>
              <p class="text-2xl font-bold">0</p>
            </div>
            <div class="flex items-center justify-center size-12 rounded-full bg-indigo-100 text-indigo-500">
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <path d="M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2" />
                <circle cx="9" cy="7" r="4" />
