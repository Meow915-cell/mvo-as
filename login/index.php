...
<body class="bg-sky-700">
    <main class="p-4 md:p-6 h-screen flex justify-center items-center w-full">
        <div class="card w-md max-w-md shadow-lg">
            ...
            <section>
                ...
                <div class=" text-rose-700 rounded mb-4">
                ...
                <form class="form grid gap-6" method="POST" action="">
                    ...
                    <div class="grid gap-2">
                        <div class="flex items-center gap-2">
                            ...
                            <a href="#" class="ml-auto inline-block text-sm underline-offset-4 hover:underline">Forgot
                                your password?</a>
                        </div>
                        <input type="password" id="password" name="password" placeholder="Enter your password" required>
                    </div>

                    <div class="cf-turnstile" data-sitekey="0x4AAAAAAB6rcIV7pi2pB8QC" data-theme="light"
                        data-size="flexible" data-callback="onSuccess" style="width: 100% !important">
                    </div>

                    <button type="submit" class="btn rounded-full text font-semibold bg-sky-700">Login</button>
                </form>
            </section>
